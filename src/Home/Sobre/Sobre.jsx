                ...
                <div className='d-flex justify-content-center align-items-center'>
                    ...
                    <div className="d-flex flex-column gap-3 sobre me-5">
                        ...
                        <div className="d-flex flex-column gap-3 text-center">
                            <span>
                                Dra. Valdéris Ott de Moura advogada de formação e militância voltada para a areia trabalhista bancaria, com mais de 21 anos de vasta experiencia e atuação em vários estados da federação, pós-graduada em gestão de pessoas, liderança e coaching pela pontifícia Universidade Católica do Rio Grande Do Sul, pós-graduada em direito empresarial pela Fundação Getúlio Vargas Goiânia e pós-graduanda em direito ambiental e gestão estratégica de sustentabilidade, pela Pontifícia Universidade Católica de São Paulo.
                            </span>
                            <span>
